...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "Morning: wake up, hit the gym or a HIIT class (7 AM, 11 AM, or 5 PM slots), Blueprint breakfast. Then head to the coworking space—everyone's doing their own thing. Most members work remotely for their existing employer or startup during the day. The coworking space, private pods, and fast Starlink internet are built for this—you don't need to quit your job to come. Afternoon: optional sessions (vibe coding, book club, DeFi 101, bug bounty hunting, whatever members teach), side projects, or deep work. Evening: community dinner, maybe a small event or just hanging out. Alcohol is minimal; caffeine is the drug of choice. It's structured but flexible—you design your day.",
    seo: {
  ...
  },
  {
    ...
    answer: "Yes. If the open coworking space isn't enough, NS offers private workspaces. There's an hourly pod in the NS Café—first come, first served, book one-hour slots via a QR code on the pod itself. It's soundproofed enough for Zoom calls and client meetings—perfect if you have daily standups. For something more permanent, you can rent a Private NS Pod ($200/month—table and monitor) or a Private NS Office ($400/month—standing desk, office chair, and monitor). If you have frequent video calls, the private office is worth it. Pods are in the café area; offices are in the library and coworking spaces. These are on top of the base membership fee, but worth it if you need a locked-in, dedicated workspace.",
    seo: {
  ...
  // === COMMUNITY & CULTURE ===
  {
    ...
    answer: "Roughly 80% of attendees come from AI, crypto, or content-creation backgrounds—those are the dominant communities. The rest includes remote workers, founders in other verticals, former military, academic professors, and teenage coders. Age range spans from 7 to 80+—members have seen both ends thrive. The core demographic is 22–40, but NS explicitly doesn't filter by age. Very international—70+ nationalities, with strong representation from India, the US, Europe, Southeast Asia, and the Middle East. Demographics skew male (around 80%). There's a mix of temporary visitors (one month to test it out) and semi-permanent residents (3–12 months); digital nomads show up too but get quickly integrated through the constant events and community programming. It's a cultural smorgasbord with a strong tech-builder bias.",
    seo: {
  ...
  },
  {
    ...
    answer: "Quiet, developing area—not a bustling city. Gender ratio skews 80% male. Some ethnic and language cliques form. Crypto infrastructure is lighter than the marketing suggests. Meal and gym schedules don't accommodate Ramadan. Singapore trips take 1.5–2 hours each way with double immigration. A few members are less social. The heat is relentless—Forest City is equatorial Malaysia, so expect 30–35°C (86–95°F) year-round with high humidity. Air conditioning is everywhere indoors, but any time outside is sweaty. Pack light, breathable clothes and sunscreen. But most people find the tradeoffs worth it for the community, focus, and network.",
    seo: {
  ...
  // === PRACTICAL ===
  {
    ...
    image: '',
    imageAlt: '',
    question: 'What should I pack for Network School?',
    answer: "Pack light—it's tropical year-round. Bring breathable clothes (cotton/linen), shorts, and sandals for daily wear. You'll need gym shoes and workout clothes for HIIT sessions. A light rain jacket is useful for sudden downpours. Power adapter: Malaysia uses UK Type G plugs (three rectangular pins). Your laptop and charger are essential—the coworking space has monitors but not spare machines. Toiletries are provided in hotel rooms but bring your preferred brands for longer stays. Sunscreen is a must. A small backpack is handy for Singapore day trips. Some Malaysian ringgit cash (RM 200–300) for local shops and Grab rides. Don't overpack—there are convenience stores and online delivery for anything you forget.",
    seo: {
      title: 'What to Pack for Network School | Complete Packing List 2026',
      description: 'Packing list for Network School: light clothes, UK plug adapter, laptop, gym shoes, sunscreen, MYR cash. What to bring to NS.',
      keywords: 'Network School packing list, what to bring to NS, Network School essentials, Malaysia plug type',
    },
  },
  {
    category: 'basics',
    slug: 'leave-and-return',
    image: '',
    imageAlt: '',
    question: 'Can I leave and come back during my stay?',
    answer: "Yes—your stay doesn't need to be continuous. Many members take weekend trips to Singapore, fly to Bali or Bangkok for a few days, or attend conferences elsewhere and come back. Your room stays reserved, and meals resume when you return. Some members even do a week on, week off pattern if they have business elsewhere in Southeast Asia. Just coordinate with NS staff so they know your schedule. The flexibility is one of the underrated perks—you're not locked into the campus 24/7.",
    seo: {
      title: 'Can You Leave and Return to Network School? Flexible Stay Policy',
      description: 'Yes, you can leave NS for trips and return. Room stays reserved. Flexible stay policy explained for Network School members.',
      keywords: 'Network School flexible stay, leave and return NS, NS travel policy',
    },
  },
  {
    category: 'application',
    slug: 'day-one-checkin',
    image: '',
    imageAlt: '',
    question: "What's the check-in process on Day 1?",
    answer: "Arrival day is straightforward. If you're coming on the 1st of the month, the NS shuttle picks you up from Singapore Changi and drops you at the hotel. Otherwise, you arrive by Grab or bus. Check in at the hotel front desk—they'll have your room ready and give you your key. NS staff will orient you: a walkthrough of the coworking space, gym, café, library, and Haven. You'll get added to the community WhatsApp/Telegram groups and the Luma events calendar. Your first meal is usually dinner—show up to the buffet and start meeting people. Most members say the first 48 hours are a whirlwind of introductions. Don't stress about planning—the community pulls you in fast.",
    ctaText: 'Apply now',
    ctaUrl: REFERRAL_URL,
    seo: {
      title: 'Network School Day 1: Check-in Process & What to Expect',
      description: 'What happens on your first day at Network School: hotel check-in, campus tour, community onboarding, first dinner. Day 1 guide.',
      keywords: 'Network School check-in, first day NS, NS arrival, what to expect day 1',
    },
  },
  {
    category: 'basics',
    ...
    answer: "Network School doesn't publicly advertise a standard refund policy. If this is a concern, check directly with NS staff before booking—they're responsive and can clarify the terms for your specific situation. The best way to de-risk your decision is to use a referral link to get your first week free. That gives you a full week to experience the campus, meals, gym, coworking, and community before committing financially. Most people know within the first few days whether NS is right for them.",
    ctaText: 'Get your free first week',
    ctaUrl: REFERRAL_URL,
    seo: {
      title: 'Network School Refund Policy: Can You Get Money Back?',
      description: 'NS refund policy is not publicly listed. Get a free first week via referral to test before committing. How to de-risk your NS decision.',
      keywords: 'Network School refund, NS cancellation policy, NS money back, Network School free trial',
    },
  },
];
